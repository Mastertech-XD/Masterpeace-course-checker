document.addEventListener("DOMContentLoaded", function() { const form = document.getElementById("gradesForm"); const clusterSelect = document.getElementById("courseCluster"); const subjectInputsDiv = document.getElementById("subjectInputs"); const resultsDiv = document.getElementById("results"); const loadingMessage = document.getElementById("loadingMessage");
